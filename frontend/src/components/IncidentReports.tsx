  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="mb-2">Incident &amp; Issue Reporting</h1>
          <p className="text-gray-600">Log and track operational incidents</p>
        </div>
        <button
      ...
      {incidents.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          <h3 className="mb-2">No incidents found</h3>
            ...
            <tbody className="divide-y divide-gray-200">
              {incidents.map((incident) => (
                <tr key={incident.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">{formatType(incident.incident_type)}</td>
                  <td className="px-6 py-4 capitalize">{incident.severity}</td>
                  ...
                  <td className="px-6 py-4 text-gray-600">{incident.reported_by_user_id}</td>
